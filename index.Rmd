...
- ### prosodic information can generate expectations about the end of a word (non-morphological ending)

--

- ### L2 learners can use this type of prediction while processing their L2


--

- ### accumulated prediction experience via interpreting can train predictive processing
...
- Constraining sentences
    - The day was breezy so the boy went outside to fly a kite / an airplane (DeLong et al., 2005)
    - But not always (Nieuwland et al., 2018) 
    
- Information contained in the verb
    - E.g. The boy will eat/move the cake (Altmann & Kamide, 1999)
---
background-size: 100%
...
- L2ers predict based on contextual information in restrictive sentences
...
- But we still don't know
  - Other cues or referents?
  - Interpreting practice enhances anticipation during non-interpreting situations?
]
...
## Prosodic cues guide morphological prediction
## Does the same mechanism apply to **any lexical item**? (non-morphological ending)
...
- Yes! Non-interpreters predicted significantly less than interpreters

- For interpreters and non-interpreters, interaction of lexical stress and syllabic structure:
    - changing from paroxytone to Oxytone + CV to CVC increased the probability of prediction
...
## crislozano.github.io/isb19_presentantion
...
background-size: 500pt
background-image: url(./img/age_gca.png)
